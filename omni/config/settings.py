...
PICKUP_CONFIRMATION_TIMEOUT_SECONDS = 3.0
PICKUP_CONFIRMATION_POLL_INTERVAL_SECONDS = 0.2
...
# Max time to wait for Mineflayer placement callbacks.
PLACE_BLOCK_TIMEOUT_SECONDS = 5
